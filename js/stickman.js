...
(function (global) {
  ...
  var POSES = {
    ...
    rowA: function () { // 划桨前伸
      return P(0.35, 14, [1.3, 0.25], [1.2, 0.3], [1.45, -0.5], [1.3, -0.55], 0.1);
    },
    rowB: function () { // 划桨后拉
      return P(-0.25, 18, [-0.4, 1.7], [-0.5, 1.7], [1.5, -0.55], [1.35, -0.6], -0.15);
    },
    fly: function (t) {
      var p = Math.sin(t * 6) * 0.06;
      return P(1.25 + p, 0, [2.0, 0.1], [2.3, 0.15], [0.15, -0.2], [-0.1, -0.3], -0.5);
    },
    // 被击倒：自定义关节坐标（趴地）
    ko: { custom: true,
